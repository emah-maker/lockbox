...
// settings/app, goals/config, sessions). What deletion removes -- everything
// above, session history included -- is spelled out in DangerZoneSection's
// delete copy instead of repeated here, since it only matters at deletion
// time. (There used to be a "sessions are retained but orphaned" exception
// named here; deleteAllUserData sweeps them now, so there is no exception.)
//
