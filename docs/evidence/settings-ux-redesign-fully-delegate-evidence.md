...
| board-settings-ux | Board on-screen settings UI | `Box-code/lib/lock_config.py`, `lock_controller.py`, `lock_ui.py`, `lock_settings.py` | Verified complete |
...
- [ ] Review the firmware-side diff: `Box-code/lib/lock_config.py`, `lock_controller.py`, `lock_ui.py`, `lock_settings.py`.
