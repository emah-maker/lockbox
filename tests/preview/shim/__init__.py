...
# plus empty stubs for everything else Box-code/lib imports at module
# scope, so the REAL firmware UI code (Box-code/lib/lock_ui*.py and its
...
# overflow_check.py add THIS DIRECTORY to sys.path (ahead of Box-code/lib),
